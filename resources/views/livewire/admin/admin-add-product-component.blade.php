   		...
   		<div class="row">
   			<div class="col-md-12">
   				<div class="panel panel-default">
                     ...
                     @endif
   						<form action="" class="form-horizontal" enctype="multipart/form-data" method="POST" wire:submit.prevent="addProduct">
                              ...
                              @enderror
   							...
   							<div class="form-group">
   								...
   								<div class="col-md-4">
   									<input type="file" placeholder="Product Image" class="input-file form-control" name="image" wire:model="image">
   									@if($image)
   									<img src="{{$image->temporaryUrl()}}" alt="" width="120px" height="120px">
   									@endif
                              @error('image')
                              <p class="text-danger">{{$message}}</p>
                              @enderror
