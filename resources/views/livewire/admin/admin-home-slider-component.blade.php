   						...
   						<table class="table table-striped">
   							<thead>
   								...
   								<tbody>
                                    ...
                                    <tr>
                                    	<td>{{$slider->id}}</td>
                                    	<td><img src="{{asset('assets/images/sliders/'.$slider->image)}}" alt="" width="100px" height="100px" class="img-thumbnail"></td>
                                    	<td>{{$slider->title}}</td>
                                       ...
                                       <td>
                                          ...
                                          <a href="#" wire:click.prevent="deleteSlide({{$slider->id}})" style="margin-right:10px;"><i  class="fa fa-trash fa-2x text-danger"></i></a>
                                       </td>
                                    </tr>
   									@endforeach
   								</tbody>
