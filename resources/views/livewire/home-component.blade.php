					...
					<div class="product product-style-2 equal-elem ">
						<div class="product-thumnail">
							<a href="{{route('product.details',['slug'=>$sproduct->slug])}}" title="{{$sproduct->name}}">
								<figure><img src="{{ asset('assets/images/products/'.$sproduct->image)}}" width="800" height="800" alt="{{$sproduct->image}}"></figure>
							</a>
						...
						<div class="product-info">
							...
							<div class="wrap-price">
								<del><span class="product-price saleprice">${{$sproduct->regular_price}}</span></del>
								<span class="product-price regprice">${{$sproduct->sale_price}}</span>
							</div>
						</div>
					</div>
					@endforeach
						...
						<div class="tab-contents">
							...
							<div class="tab-content-item {{$key==0?'active':''}}" id="category_{{$category->id}}">
								<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
										...
										<div class="product product-style-2 equal-elem ">
											<div class="product-thumnail">
												<a href="detail.html" title="{{$c_product->name}}">
											...
											<div class="product-info">
												<a href="route){{route('product.details',['slug'=>$c_product->slug])}}" class="product-name"><span>{{$c_product->name}}</span></a>
