                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6" style="">
                                ...
                                <a href="#" wire:click.prevent="cancelOrder({{$order->id}})" style="margin-right:20px" class="btn btn-warning pull-right">Cancel Order</a>
                                @endif
                            </div>
                        </div>
                            ...
                            <ul class="products-cart">
                                ...
                                <li class="pr-cart-item">
                                    ...
                                    <div class="product-name">
                                        <a class="link-to-product" href="{{route('product.details',['slug'=>$item->product->name])}}">{{$item->product->name}}</a>
                                    </div>
